...
export default function About() {
  return (
    <div className="min-h-screen bg-background page-enter-active">
      {/* Hero */}
      <div className="relative h-[60vh] bg-secondary flex items-center justify-center overflow-hidden texture-grain">
        <div className="absolute inset-0 bg-black/20 z-0" />
        <div className="container relative z-10 text-center px-4">
          <h1 className="font-display text-5xl md:text-7xl font-bold text-background mb-6">Our Story</h1>
      ...
      <div className="container px-4 py-20 max-w-4xl mx-auto space-y-20">
        <section>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-display text-3xl font-bold mb-6 text-primary">Our Philosophy</h2>
        ...
        <section className="text-center bg-muted/30 p-12 rounded-3xl">
          <h2 className="font-hand text-4xl font-bold mb-6 text-secondary">"Food is symbolic of love when words are inadequate."</h2>
